...
XMLIdealGeometryESSource = cms.ESSource("XMLIdealGeometryESSource",
    geomXMLFiles = cms.vstring('Geometry/CMSCommonData/data/materials.xml',
        ...
        'Geometry/HGCalCommonData/data/v5_NoEE/hgcal.xml',
        'Geometry/HGCalCommonData/data/v5_NoEE/hgcalEE.xml',
        'Geometry/HGCalCommonData/data/v5_NoEE/hgcalHEsil.xml',
        'Geometry/HGCalCommonData/data/v5_NoEE/hgcalHEsci.xml',
        'Geometry/HGCalCommonData/data/v5_NoEE/hgcalCons.xml',
