...
XMLIdealGeometryESSource = cms.ESSource("XMLIdealGeometryESSource",
    geomXMLFiles = cms.vstring('Geometry/CMSCommonData/data/materials.xml',
        ...
        'Geometry/HGCalCommonData/data/v4_NoEE/hgcal.xml',
        'Geometry/HGCalCommonData/data/v4_NoEE/hgcalEE.xml',
        'Geometry/HGCalCommonData/data/v4_NoEE/hgcalHEsil.xml',
        'Geometry/HGCalCommonData/data/v4_NoEE/hgcalHEsci.xml',
        'Geometry/HGCalCommonData/data/v4_NoEE/hgcalCons.xml',
